...
// LIC//
// LIC//====================================================================
#ifndef OOMPH_GMSH_MESH_TEMPLATE_HEADER
#define OOMPH_GMSH_MESH_TEMPLATE_HEADER

#ifndef OOMPH_GMSH_MESH_HEADER
#error __FILE__ should only be included from gmsh_mesh.h.
#endif // OOMPH_GMSH_MESH_HEADER
